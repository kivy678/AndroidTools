...
class TipOPCODE(MethodView):
    ...
    def post(self):
        ...
        df_opcode.DATA_FRAME.loc[sha256, 'arch']        = request.form.get('GetArch')
...
tipOpcode_view = TipOPCODE.as_view('opcode', template_name='tip/opcode.jinja')
