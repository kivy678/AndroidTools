...
static PyObject *
dis(PyObject* self, PyObject* a_args)
{
	const char* args;
	...
	if (cs_open(CS_ARCH_X86, CS_MODE_32, &handle) != CS_ERR_OK)			// CS_ARCH_ARM, CS_MODE_ARM(CS_MODE_THUMB)
...
static PyMethodDef DisassembleMethods[] = {
	{"dis", dis, METH_VARARGS, "OPcode disassemble"},
	{NULL, NULL, 0, NULL}
};


static struct PyModuleDef disassemblemodule = {
